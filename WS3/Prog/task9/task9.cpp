...
int main(){
	...
	file << "#2-dim gausslegendre product rule quadrature nodes level=5\n";
	...
	file.close();
	file.open("cc.dat");
	file << "#2-dim clenshaw-curtis product rule quadrature nodes level=5\n";
	...
	file << "#2-dim trapezoidal product rule quadrature nodes level=5\n";
